 ...
 * All fixes applied: FULLTEXT search, Always show sections
...
<body>
    ...
    <div class="property-card-actions" style="margin-top: 1rem; display: flex; gap: 0.5rem;">
        <?php if ($is_rent): ?>
            ...
            <a href="payment.php?property_id=<?php echo $property['id']; ?>" 
               style="flex: 1; background: #28a745; color: white; padding: 0.5rem 1rem; text-align: center; border-radius: 5px; text-decoration: none; font-size: 0.9rem;">
                <i class="fas fa-lock"></i> Pay to View
            </a>
            
            <button onclick="shareProperty(<?php echo $property['id']; ?>)" 
                    style="background: #6c757d; color: white; padding: 0.5rem; border-radius: 5px; border: none; cursor: pointer;">
